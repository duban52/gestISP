    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="card col-md-5 ml-md-1">
            ...
            <div class="card-body row">
                <p class="col-6"><strong>C.C/NIT:</strong> {{ $invoice->titular()?->identity_number }}</p>
                <p class="col-6"><strong>SUSCRIPTOR:</strong> {{ trim(($invoice->titular()?->name ?? '') . ' ' . ($invoice->titular()?->last_name ?? '')) ?: '—' }}</p>
                ...
                <p class="col-6"><strong>CORREO:</strong> {{ $invoice->titular()?->email }}</p>
                <p class="col-6"><strong>TELÉFONO:</strong> {{ $invoice->titular()?->number_phone}}</p>
            </div>
        </div>
